...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    ...
    assert_difference('Seller.count') do
      post sellers_url, params: {seller: {auth_token: @seller.auth_token, dislikes: @seller.dislikes, likes: @seller.likes, name: @seller.name}}
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: {seller: {auth_token: @seller.auth_token, dislikes: @seller.dislikes, likes: @seller.likes, name: @seller.name}}
