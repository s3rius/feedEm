...
class MerchandisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchandise" do
    ...
    assert_difference('Merchandise.count') do
      post merchandises_url, params: { merchandise: { cook_time: @merchandise.cook_time, description: @merchandise.description, name: @merchandise.name, price: @merchandise.price, seller_id: @merchandise.seller_id } }
    end
  ...
  test "should update merchandise" do
    patch merchandise_url(@merchandise), params: { merchandise: { cook_time: @merchandise.cook_time, description: @merchandise.description, name: @merchandise.name, price: @merchandise.price, seller_id: @merchandise.seller_id } }
